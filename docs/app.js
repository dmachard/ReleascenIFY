...
const i18n = {
    fr: {
        ...
        notes: {
            ...
            srcRemuxQual: "Remux 4K",
            srcBluraySrc: "BluRay / BDRip",
            srcBlurayQual: "Re-encoded",
            srcWebdlSrc: "WEB-DL",
            srcWebdlQual: "Direct download",
            srcWebripSrc: "WEBRip",
            srcWebripQual: "Re-encoded",
            srcHdtvSrc: "HDTV",
            srcHdtvQual: "Broadcast capture",
            srcHdripQual: "Re-encoded",
            srcCamSrc: "HDCAM / CAM",
            ...
            codecVc1: "VC-1 (ancien codec Microsoft, format Blu-Ray d'époque)",
    ...
    en: {
        ...
        notes: {
            ...
            srcRemuxSrc: "UHD.BluRay / BluRay.REMUX",
            srcRemuxQual: "4K BluRay Remux",
            srcBluraySrc: "BluRay / BDRip",
            srcBlurayQual: "Re-encoded",
            srcWebdlSrc: "WEB-DL",
            srcWebdlQual: "Direct download",
            srcWebripSrc: "WEBRip",
            srcWebripQual: "Captured and re-encoded",
            srcHdtvSrc: "HDTV",
            srcHdtvQual: "Broadcast capture",
            srcCamSrc: "HDCAM / CAM",
            ...
            codecVc1: "VC-1 (legacy Microsoft codec, early Blu-Ray format)",
            ...
            audioLossless: "Lossless audio (TrueHD / Atmos / FLAC)",
            audioDd: "Dolby Digital 5.1 (AC3 / DD5.1)",
    ...
    const cards = [
        ...
        },
        {
            ...
            rows: [
                ...
                ["VC-1", `VC-1 - ${i18n[currentLang].notes.codecVc1}`, `<span class="stars">★★☆☆☆</span>`]
            ]
        },
        {
            id: 'lang',
        ...
        },
        {
            ...
            rows: [
                ...
                ["DTS-HD MA / DTS-HD", i18n[currentLang].notes.audioDtshdma, `<span class="stars">★★★★★</span>`],
                ["DTS", i18n[currentLang].notes.audioDts, `<span class="stars">★★★★☆</span>`],
